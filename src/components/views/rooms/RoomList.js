...
const STANDARD_TAGS_REGEX = /^(m\.(favourite|lowpriority|server_notice)|im\.vector\.fake\.(invite|recent|direct|archived|text))$/;
...
function phraseForSection(section) {
    console.log("PHRASE FOR SECTION IN ROOMLIST IS USED");
    switch (section) {
        case "m.favourite":
            return _t("Drop here to favourite");
        case "im.vector.fake.direct":
            return _t("Drop here to tag direct chat");
        case "im.vector.fake.text":
            return "Drop here to tag text message";
...
module.exports = React.createClass({
    ...
    getInitialState: function() {
        ...
        console.log("THIS IS THE DATA I WANT", this._subListRefs);
    },
