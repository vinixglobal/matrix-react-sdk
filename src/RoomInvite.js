...
export function showTextMessage() {
    const AddressPickerDialog = sdk.getComponent("dialogs.AddressPickerDialog");

    Modal.createTrackedDialog("Send a text", "", AddressPickerDialog, {
        title: "Send a text",
        description: "Enter the phone number of person you are texting",
        placeholder: "1 (954) 414-1212",
        validAddressTypes: ["phone-number"],
        button: "Send Text",
        onFinished: _onStartChatFinished
    });
}

//THESE SHOULD PUSH INTO RESPECTIVE ROOMS
